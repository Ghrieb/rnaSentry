...
(`validation/simulate_study.R`, Sim 5): with fewer than ~5 events per
signature gene, neither the concordance nor the hazard ratios are
trustworthy, and a *mean* C-index hides the instability that the
fold-level table exposes.
