...
README and main vignette; the numbers come from a live GEO reproduction.
Because the data are downloaded live, the walkthrough is narrative here
rather than a build-time vignette:
