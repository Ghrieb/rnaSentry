...
| 1 | Full test suite | `Rscript <temp>/run_tests_parity.R` (devtools::test) — 142 blocks / 441 expectations / 0 fail / 0 error / 32 expected guardrail warnings |
...
1. Gate 1 suite (142/441, 0 fail, 0 error).
